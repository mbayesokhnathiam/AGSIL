...
class _ExploreDetailState extends State<ExploreDetail> {
  ...
  getDetails() async {
    ...
    var response;
    await  ApiService().getData("events/detail/${widget.event.id}").then((value) =>{
      response=value
    ...
    setState(() {
      ...
      options=OptionModel.fromJsonList(response["data"]["place"]["place_options"]);
     _loading=false;
    });
  ...
  noter(note) async{
    ...
    await ApiService().postData(body, path).then((value) => {
      response=value
        ...
        child: SingleChildScrollView(child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage("${APIConstants.IMG_BASE_URL}${event!.event_image}"),
                      fit: BoxFit.cover)),
            ),
            Container(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          print(double.parse(place.localisation.split(",")[0]));
                         MapsLauncher.launchCoordinates(double.parse(place.localisation.split(",")[0]),double.parse(place.localisation.split(",")[1]));
                            ...
                            Row(
                              children: [
                                RatingBar.builder(
                                  ...
                                  itemSize: 20, // largeur personnalisée pour chaque étoile
                ...
                children: [
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap:(){
                          Open.mail(toAddress: place.email, subject: "", body: "");
            ...
            Wrap(
              ...
              runSpacing: 10.0, // Espace vertical entre chaque ligne d'éléments
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(
                          ...
                          (
                              option.icon=="wifi"? Icons.wifi:(
                                  option.icon=="tv"?Icons.tv:(
                                      option.icon=="space"?Icons.space_bar_outlined:(

                                          option.icon=="piscine"?Icons.water:Icons.warehouse_outlined
                                  ))
                              )
                          ),
                          color: primary,

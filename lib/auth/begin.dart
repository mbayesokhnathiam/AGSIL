...
class _beginState extends State<Begin> {
  ...
  getDatas(String countryName) async {
    setState(() {
      _loading = true;
    });
    ...
    setState(() {
      ...
      countrie = countries.where((c) => c.nom_en_gb == countryName).first;
      if (countrie != null) _countryKey.currentState!.didChange(countrie);
    });
  }
